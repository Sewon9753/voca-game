...
- 시험지 인쇄: `python3 test_sheet.py day06 --mode en2ko ko2en --print`(영→뜻·뜻→영 각 1장+정답지) · `python3 test_sheet.py section10-1 section10-2 --mode en2ko --print`(두 팩 합쳐 80문항). 기본 섞기(`--order print`로 프린트 순), 산출물 `sheets/`(git 제외), 출력은 맥북 Canon G4010(localprint 경유).
